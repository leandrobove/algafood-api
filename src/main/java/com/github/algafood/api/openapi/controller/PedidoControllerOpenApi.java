...
public interface PedidoControllerOpenApi {
	...
	PedidoModel buscar(@ApiParam(value = "Código de um pedido", 
			example = "7035f4b8-a79a-4c2b-9a7e-a6f4c200f269", required = true) String codigoPedido);

	@ApiOperation(value = "Cadastra um novo pedido")
	PedidoModel cadastrar(@ApiParam(name = "corpo", value = "Representação de um novo pedido", required = true) PedidoInput pedidoInput);
