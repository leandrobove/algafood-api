...
public interface FormaPagamentoControllerOpenApi {
	...
	FormaPagamentoModel cadastrar(@ApiParam(name = "corpo", value = "Representação de uma nova forma de pagamento") 
	...
	void deletar(@ApiParam(value = "ID de uma forma de pagamento", example = "1") Long formaPagamentoId);
