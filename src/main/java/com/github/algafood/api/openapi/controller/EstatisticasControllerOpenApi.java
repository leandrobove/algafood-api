...
public interface EstatisticasControllerOpenApi {
	...
	List<VendaDiaria> listarPorVendasDiarias(VendaDiariaFilter filter, @ApiParam(value = "Deslocamento de horário a ser considerado na consulta em relação ao UTC",
			defaultValue = "+00:00") String timeOffset);

	ResponseEntity<byte[]> listarPorVendasDiariasPdf(VendaDiariaFilter filter, String timeOffset);
}
